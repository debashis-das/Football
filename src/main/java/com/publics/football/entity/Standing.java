...
public class Standing {
	...
	public String toString() {
		return "Standing [country_name=" + country_name + ", league_id=" + league_id + ", league_name=" + league_name
				+ ", team_id=" + team_id + ", team_name=" + team_name + ", overall_league_position="
				+ overall_league_position + ", overall_league_payed=" + overall_league_payed + ", overall_league_W="
				+ overall_league_W + ", overall_league_D=" + overall_league_D + ", overall_league_L=" + overall_league_L
